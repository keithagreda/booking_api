...
namespace booking_api.Migrations
{
    ...
    [Migration("20260504212611_TrustScoreAndEmailService")]
    partial class TrustScoreAndEmailService
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("booking_api.Models.TrustScoreHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("booking_api.Models.User", b =>
                {
                    ...
                    b.Property<DateTime?>("LastTrustAdjustment")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("booking_api.Models.TrustScoreHistory", b =>
                {
                    ...
                    b.HasOne("booking_api.Models.User", "TriggeredByUser")
                        .WithMany()
